...
public static class BrokenFileSample
{
    public static void Execute()
    {
        var fileStream = File.OpenRead("..\\..\\..\\Files\\BrokenFile.xlsx");
        ...
        var worksheetParser = worksheet.GetParser<CocktailModel>(new WorksheetParserConfiguration()
        {
            UseHeaders = false
        });
